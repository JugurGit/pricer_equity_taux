...
class BarrierOptionMCEngine : public pricer::core::PricingEngine {
public:
    BarrierOptionMCEngine(std::shared_ptr<pricer::models::BlackScholesModel> model,
                          std::size_t nPaths,
                          std::size_t nSteps,
                          unsigned long seed = 123UL)
